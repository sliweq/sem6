    ...
    <div>
        ...
        <div v-else>
            <form @submit.prevent="submitAuthor">
                ...
                <p>Surname</p>
                <input v-model="surname" maxlength="100" required />
    ...
    methods: {
        async fetchAuthor(id) {
            try {
                ...
                [this.name, this.surname] = author.name.split(" ", 2);
            } catch (e) {
        ...
        async submitAuthor() {
            ...
            try {
                ...
                if (!response.ok) {
                    throw new Error(`Failed to edit author: ${response.status}`);
                }
                ...
                alert("Error editing author: " + e.message);
            }
        }
    }
};
